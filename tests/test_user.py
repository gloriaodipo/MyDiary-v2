...
class Test_User_Case(BaseTestClass):
    ...
    def test_wrong_signup(self):
        ...
        response = self.client.post(SIGNUP_URL,
                                    data=json.dumps(
                                        {'username': 'gloria', 'email': 'godipo@gmail.com', 'password': ''}),
    ...
    def test_cannot_signup_with_invalid_username(self):
        ...
        response = self.client.post(SIGNUP_URL,
                                    data=json.dumps(
                                        {'username': '#$gloria', 'email': 'godipo@gmail.com', 'password': 'passw'}),
                                    content_type='application/json')
        self.assertEqual(response.status_code, 400)
        result = json.loads(response.data.decode())
    ...
    def test_cannot_signup_with_wrong_email_format(self):
        ...
        response = self.client.post(SIGNUP_URL,
                                    data=json.dumps(
                                        {'username': 'gloria', 'email': 'godipogmail.com', 'password': 'passw'}),
                                    content_type='application/json')
        self.assertEqual(response.status_code, 400)
        result = json.loads(response.data.decode())
        self.assertEqual(
    ...
    def test_cannot_signup_with_short_username(self):
        ...
        response = self.client.post(SIGNUP_URL,
                                    data=json.dumps(
                                        {'username': 'glo', 'email': 'godipo@gmail.com', 'password': 'password'}),
                                    content_type='application/json')
        self.assertEqual(response.status_code, 400)
        result = json.loads(response.data.decode())
    ...
    def test_cannot_signup_with_short_password(self):
        ...
        response = self.client.post(SIGNUP_URL,
                                    data=json.dumps(
                                        {'username': 'gloriao', 'email': 'godipo@gmail.com', 'password': 'pass'}),
                                    content_type='application/json')
        self.assertEqual(response.status_code, 400)
        result = json.loads(response.data.decode())
        self.assertEqual(result["message"],
    ...
    def test_login(self):
        ...
        response = self.client.post(LOGIN_URL,
                                    data=json.dumps(
                                        {'username': 'gloria', 'password': 'password'}),
                                    content_type='application/json')
    ...
    def test_wrong_password(self):
        ...
        response = self.client.post(LOGIN_URL,
                                    data=json.dumps(
                                        {'username': 'gloria', 'password': 'wrong_password'}),
                                    content_type='application/json')
    ...
    def test_login_nonexistent_user(self):
        ...
        response = self.client.post(LOGIN_URL,
                                    data=json.dumps(
                                        {'username': 'nonexistent', 'password': 'wrong_password'}),
                                    content_type='application/json')
